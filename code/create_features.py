...
def get_feature_vector(y,sr,S,song_id):
    ...
    #feature.delta, arg is mfcc
    #frames_to_time(onset_frames[:20], sr=sr)
    #feature.rhythm.fourier_tempogram, .real
    #beat.beat_track, average
...
if __name__ == '__main__':
    ...
    output = '../input/features_' + num + '.csv'
